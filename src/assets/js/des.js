...
export default {
    ...
    genkey(key, start, end) {
        // 8 byte / 64 bit Key (DES) or 192 bit Key
        return { key: this.pad(key.slice(start, end)), vector: 1 };
    },
    pad(key) {
    ...
    decrypt(input, key, des3iv) {
        //var genKey = this.genkey(key, 0, 24)
        return this.des(key, atob(input), 0, 1, des3iv, 1);
    },
};
// var des3iv = '12345678'
// var DES3 = {
