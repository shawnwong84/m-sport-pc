    ...
    return (function (e) {
                    ...
                    (d.IS_MOBILE
                        ...
                        : ((e.flash = !!t.isFormat('rtmp') || e.flash),
                          ...
                          e.flash
                              ...
                              ? e.h5_flv &&
                                ((d.IS_SAFARI &&
                                    A.compareVersion(d.SAFARI_VERSION, '10.1') >
                                        -1) ||
                                    !d.IS_SAFARI)
                                  ? (b.pc = ['flv', 'm3u8', 'mp4'])
                                  : (b.pc = ['m3u8', 'mp4'])
            ...
            t.TcPlayer = (function (e) {
                function t(i, o) {
                    ...
                    var l = {
                        ...
                        showLoading:
                            'boolean' != typeof o.showLoading || o.showLoading,
                        pausePosterEnabled:
                            void 0 === o.pausePosterEnabled ||
                            o.pausePosterEnabled,
                        fullscreenEnabled:
                            void 0 === o.fuScrnEnabled || o.fuScrnEnabled,
                ...
                return (
                    ...
                    (t.prototype._switchClarity = function (e) {
                        ...
                        var r = A.bind(this, function () {
                            parseInt(this.duration() - t) > 0 &&
                                !this.options.live &&
                                this.currentTime(t),
                                n && this.play(!0),
                                g.unsub(w.MetaLoaded, '*', r, this);
                        });
                        g.sub(w.MetaLoaded, '*', r, this);
                    }),
                    (t.prototype.switchClarity = function (e) {
                        this.claritySwitcher
                            ? this.claritySwitcher.setClarity(e)
                            : this._switchClarity(e);
                    }),
        ...
        function (e, t) {
            ...
            var i = window.navigator.userAgent,
                ...
                p =
                    ((t.IS_OLD_ANDROID = c && /webkit/i.test(i) && u < 2.3),
                ...
                y =
                    ...
                    (t.BACKGROUND_SIZE_SUPPORTED =
                        'backgroundSize' in
                        document.createElement('video').style),
                    (t.HASVIDEO =
                ...
                A =
                    ...
                    (t.IS_QQB = !y && / QQBrowser\/\d+/i.test(i)),
                ...
                if (document.all || f)
                    ...
                    try {
                        if (
                            ...
                            for (
                                var i = e.description.split(' '), o = 0;
                                o < i.length;
                                ++o
                            )
                                isNaN(parseInt(i[o])) ||
                                    ((t.FLASH_VERSION = A = i[o]),
                                    window.console &&
                                        console.log(
                                            'FLASH_VERSION',
                                            parseInt(i[o]),
        ...
        function (e, t) {
            ...
            function s(e, t) {
                e.classList
                    ? e.classList.add(t)
                    : c(e, t) || (e.className = e.className + ' ' + t);
            }
            function l(e, t) {
                e.classList
            ...
            function h(e, t, i) {
                ...
                return (
                    ...
                    (o.y = Math.max(0, Math.min(1, (l - c + s) / s))),
        ...
        function (e, t, i) {
            ...
            function a(e) {
                (h.__isFullscreen = !!document[_.fullscreenElement]),
                    h.__isFullscreen ||
                        ...
                        w.off(document, _.fullscreenchange, a)),
                    M.pub(
                        {
                            type: b.MSG.FullScreen,
                            src: 'util',
                            ts: e.timeStamp,
                            detail: { isFullscreen: h.__isFullscreen },
                        },
                        h.player,
                    );
            }
            ...
            function h(e, t, i) {
                ...
                (h.player = e),
                    _.requestFullscreen
                        ? t
                            ? (I.IS_X5TBS &&
                                  w.on(e.video.el, 'x5videoexitfullscreen', c),
                              w.on(document, _.fullscreenchange, a),
                        ...
                        ? (w.on(e.video.el, 'webkitbeginfullscreen', u),
                          t
                              ? e.video.el.webkitEnterFullScreen()
                              : e.video.el.webkitExitFullscreen())
                        : ((h.__isFullscreen = t),
                          h.__isFullscreen
                              ? ((h.__origOverflow =
            ...
            (t.CDNPath =
                'https://cloudcache.tencent-cloud.com/open/qcloud/video/vcplayer/'),
                    ...
                    for (var a in s)
                        if (('*' === e || a == e) && s.hasOwnProperty(a))
                            if ('*' !== i) {
                                ...
                                0 == c.length && delete s[a][i.guid],
                                    p.isEmpty(s[a]) && delete s[a];
                            } else {
                ...
                return (
                    (e.prototype.render = function (e) {
                        ...
                        if (
                            ...
                            (this.options.width =
                                this.options.width || e.offsetWidth),
                            (this.options.height =
                                this.options.height || e.offsetHeight),
                            this.size(this.options.width, this.options.height),
                            !this.verifyOptions())
                        )
                            return (
                                this.listener({ type: 'error', code: 5 }),
                        ...
                        (this.poster = new S['default'](this)),
                            ...
                            (((C.IS_SAFARI &&
                                parseInt(C.SAFARI_VERSION) > 10) ||
                                C.IOS_VERSION > 10) &&
                                'system' == this.options.controls) ||
                                ((this.bigplay = new b['default'](this)),
                    ...
                    (e.prototype.size = function (e, t, i) {
                        ...
                        (n += o.test(n) ? '' : 'px'),
                            ...
                            this.video &&
                                (this.video.width(n), this.video.height(r)),
                            (this.width = n),
                            (this.height = r);
                    }),
                    (e.prototype.setup = function () {
                        if (
                            ((this.__handleEvent = x.bind(
                                this,
                                this.handleEvent,
                            )),
                            C.IS_MOBILE)
                    ...
                    (e.prototype.handleMsg = function (e) {
                        switch (e.type) {
                            ...
                            case O.Play:
                                ...
                                !this.hasPlay &&
                                    this.options.flash &&
                                    (this.mtaReport.reportFlash(),
                                    (this.hasPlay = !0)),
                                    P.addClass(this.el, 'vcp-playing'),
                                    this.video.type() == x.VideoType.RTMP &&
                                        ((this.__wait = !0),
                                        this.loading.show()),
                                    P.on(
                                        this.el,
                            ...
                            case O.TimeUpdate:
                                this.__wait &&
                                    ((this.__wait = !1), this.loading.hide());
                                break;
                            case O.Pause:
                    ...
                    (e.prototype.buffered = function () {
                        return this.video.duration()
                            ? this.video.buffered() / this.video.duration()
                            : 0;
                    }),
            ...
            function n(e) {
                for (var t = [], i = {}, o = 0; o < e.length; o++) {
                    var n = e[o],
                        ...
                        l = n[2],
                        a = n[3],
                        c = { css: s, media: l, sourceMap: a };
                    i[r]
                        ? i[r].parts.push(c)
                        : t.push((i[r] = { id: r, parts: [c] }));
                }
                return t;
            }
            function r(e, t) {
                ...
                b = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function (t) {
                            ...
                            return (
                                (i =
                                    o.poster && 'object' == a(o.poster)
                                        ? o.poster.src
                                        : 'string' == typeof o.poster
                                        ? o.poster
                                        : null),
                                this.createEl('video', {
                                    controls: n,
                                    ...
                                    'x5-video-player-fullscreen':
                                        !!o.x5_fullscreen || null,
                                    'x5-video-orientation':
                                        [
                                            'landscape',
                                            'portrait',
                                            'landscape|portrait',
                                        ][o.x5_orientation] || null,
                                    'x5-playsinline':
                                        1 == !!o.x5_playsinline
                                            ? o.x5_playsinline
                                            : null,
                                ...
                                switch (i) {
                                    case Hls.ErrorTypes.NETWORK_ERROR:
                                        o.indexOf('TimeOut') > 0
                                            ...
                                            : f.console.error(
                                                  '鏃犳硶鍔犺浇瑙嗛鏂囦欢锛岃妫€鏌ョ綉缁滐紝浠ュ強瑙嗛鏂囦欢鏄惁鍏佽璺ㄥ煙璇锋眰璁块棶锛宮3u8鏂囦欢鏄惁瀛樺湪 ' +
                                                      (t.response &&
                                                      t.response.status
                                                          ? 'netstatus:' +
                                                            t.response.status
                        ...
                        (t.prototype.__flvLoaded = function (e) {
                            ...
                            this.hls &&
                                (this.hls.stopLoad(), this.hls.detachMedia()),
                                this.flv &&
                                    (this.flv.detachMediaElement(),
                                    this.flv.destroy());
                            ...
                            t.attachMediaElement(this.el),
                                t.on(
                                    ...
                                    f.bind(this, function (e, t, i) {
                                        var o = { type: 'error' };
                                        e == flvjs.ErrorTypes.NETWORK_ERROR &&
                                            (o.code = 2),
                                            e == flvjs.ErrorTypes.MEDIA_ERROR &&
                                                (o.code = 1002),
                        ...
                        (t.prototype.setup = function () {
                            (this.playState = v.PlayStates.IDLE),
                                ...
                                this.load(
                                    this.options.src,
                                    this.options.m3u8 ? f.VideoType.M3U8 : '',
                                );
                        }),
                        ...
                        (t.prototype.width = function (e) {
                            return e
                                ? void (this.el.style.width = e)
                                : this.el.width;
                        }),
                        (t.prototype.height = function (e) {
                            return e
                                ? void (this.el.style.height = e)
                                : this.el.height;
                        }),
                        ...
                        (t.prototype.buffered = function () {
                            return this.el.buffered.length >= 1
                                ? this.el.buffered.end(
                                      this.el.buffered.length - 1,
                                  )
                                : 0;
                        }),
                        ...
                        (t.prototype.load = function (e, t) {
                            ...
                            if (
                                !m.IS_ENABLED_MSE ||
                                (!i && !o) ||
                                (m.IS_X5TBS && this.player.options.x5_player) ||
                                (i && m.IS_MAC && m.IS_SAFARI && !m.IS_IOS)
                            )
                                this.hls &&
                                    (this.hls.stopLoad(),
                                    this.hls.detachMedia()),
        ...
        function (e, t, i) {
            ...
            function s(e, t) {
                return t.guid && String(t.guid).indexOf('_') == -1
                    ? e + '_' + t.guid
                    : t.guid;
            }
            t.__esModule = !0;
                    ...
                    return (
                        ...
                        (t.prototype.render = function (e) {
                            ...
                            var t = this.player.options,
                                i = y.unifyProtocol(
                                    t.flashUrl ||
                                        '//cloudcache.tencent-cloud.com/open/qcloud/video/player/release/QCPlayer.swf',
                                ),
                                o = 'opaque',
                            ...
                            (s.innerHTML =
                                ...
                                (window[this.__flashCB].fnObj[this.__id] =
                                    y.bind(this, this.notify));
                        }),
                        (t.prototype.setup = function () {
                        ...
                        (t.prototype.destroy = function () {
                            'undefined' != typeof this.el &&
                                'undefined' != typeof this.el.destroy &&
                                this.el.destroy(),
                                this.endPolling(),
                                ...
                                switch (
                                    ...
                                    case 'ready':
                                        if (
                                            ...
                                            try {
                                                ...
                                                console.warn(
                                                    'Flash 璋冪敤澶辫触锛岃妫€鏌lash鏄惁鍚敤鎴愬姛',
                                                );
                                            }
                                            (this.__timebase =
                                                new Date() - t.time),
                                    ...
                                    case 'metaData':
                                        (i.type = p.MSG.MetaLoaded),
                                            ...
                                            (this.__m3u8 =
                                                t.type === y.VideoType.M3U8),
                                            (this.__rtmp =
                                                t.type === y.VideoType.RTMP),
                                            (this.__type = t.type),
                                            (this.__metaloaded = !0),
                                            (this.metaDataLoaded = !0),
                                            this.doPolling();
                                        ...
                                        setTimeout(function () {
                                            o.cover &&
                                                (o.owner.removeChild(o.cover),
                                                (o.cover = null));
                                        }, 500);
                                        break;
                                    case 'playState':
                                        (this.playState = t.playState),
                                            t.playState == v.PlayStates.PLAYING
                                                ? ((this.__playing = !0),
                                                  (this.__stopped = !1),
                                                  (i.type = p.MSG.Play))
                                                : t.playState ==
                                    ...
                                    case 'error':
                                        ...
                                        var n = isNaN(parseInt(t.code))
                                                ? 1002
                                                : t.code,
                                            r = isNaN(parseInt(t.code))
                                                ? t.code
                                                : t.msg,
                                            s = r.match(/#(\d+)/);
                                        s && s[1] && (n = s[1]),
                        ...
                        (t.prototype.play = function (e) {
                            this.playState == v.PlayStates.PAUSED ||
                            this.playState == v.PlayStates.PLAYING ||
                            e
                        ...
                        (t.prototype.togglePlay = function () {
                            if (this.metaDataLoaded)
                                if (this.playState == v.PlayStates.PAUSED)
                                    ...
                                    this.currentTime(0), this.el.playerResume();
                                else
                                    try {
                                        this.el.playerPlay();
                                    } catch (e) {
                        ...
                        (t.prototype.mute = function (e) {
                            return 'undefined' == typeof e
                                ? 0 == this.volume()
                                : void this.volume(e ? 0 : this.__lastVol);
                        }),
                        (t.prototype.volume = function (e) {
                            return 'undefined' == typeof e
                        ...
                        (t.prototype.playing = function () {
                            return (
                                this.el &&
                                this.el.getState &&
                                this.el.getState().playState ===
                                    v.PlayStates.PLAYING
                            );
                        }),
                        (t.prototype.type = function () {
                            return this.__type;
                    ...
                    return (
                        ...
                        (t.prototype.render = function (t) {
                            return (
                                ...
                                (this.playToggle = new p['default'](
                                    this.player,
                                )),
                                this.playToggle.render(this.el),
                                (this.timelabel = new g['default'](
                                    this.player,
                                )),
                                ...
                                this.options.fullscreenEnabled === !0 &&
                                    ((this.fullscreen = new d['default'](
                                        this.player,
                                    )),
                                    this.fullscreen.render(this.el)),
                                L.IS_MOBILE ||
                                    ((this.volume = new w['default'](
                                        this.player,
                                    )),
                                    this.volume.render(this.el)),
                                this.options.videoSource &&
                                    this.options.videoSource.definitions
                                        .length > 1 &&
                                    !L.IS_MOBILE &&
                                    ((this.claritySwitcher = new M['default'](
                                        this.player,
                                    )),
                        ...
                        (t.prototype.handleMsg = function (e) {
                            switch (e.type) {
                                case S.MSG.MetaLoaded:
                                    this.timeline.percent(
                                        this.player.percent(),
                                    ),
                                        this.timeline.buffered(
                                            this.player.buffered(),
                                        ),
                                        this.player.volume(
                                            'undefined' ==
                                                typeof this.options.volume
                                                ? 0.5
                                                : this.options.volume,
                                        ),
                        ...
                        (t.prototype.toggle = function () {
                            E.hasClass(this.el, 'show')
                                ? this.hide()
                                : this.show();
                        }),
                        (t.prototype.show = function () {
                            E.hasClass(this.el, 'hide') &&
                                (E.removeClass(this.el, 'hide'),
                            ...
                            this.vertical
                                ...
                                : ((this.__percent = t.x),
                                  (this.thumb.style.left =
                                      100 * this.__percent + '%')),
                                (this.__percent = Number(
                                    this.__percent.toFixed(3),
                                )),
                                this.pub({
                                    type: f.Changing,
                                    src: this,
            ...
            var a = i(30),
                ...
                y = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.handleMsg = function (e) {
                            e.type === a.MSG.Changing
                                ? ((this.scrubbing = !0),
                                  this.syncLabel(this.percent()))
                                : e.type === a.MSG.Changed &&
                                  (this.scrubbing = !1);
                        }),
        ...
        function (e, t, i) {
            ...
            var a = i(30),
                ...
                f = (function (e) {
                    function t(i) {
                        return (
                            r(this, t), s(this, e.call(this, i, 'Timelabel'))
                        );
                    }
                    return (
                        l(t, e),
                ...
                v = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.syncMute = function (e) {
                            e
                                ? d.addClass(this.el, 'vcp-volume-muted')
                                : d.removeClass(this.el, 'vcp-volume-muted'),
                                (this.__muted = e);
                        }),
                        ...
                        (t.prototype.percent = function (e) {
                            return 'undefined' == typeof e
                                ? 1 - this.volume.percent() || 0
                                : (this.player.volume(e), e);
                        }),
                        t
                    );
                })(p['default']);
        ...
        function (e, t, i) {
            ...
            var a = i(24),
                ...
                h = i(3),
                d = o(h),
                f = { od: '瓒呮竻', hd: '楂樻竻', sd: '鏍囨竻' },
                y = (function (e) {
                    function t(i) {
                        r(this, t);
                        var o = s(this, e.call(this, i, 'ClaritySwitcher'));
                        return (
                            (f = d.extend({}, i.options.clarityLabel, f)),
                            (i.claritySwitcher = o),
                            o
                        );
                    }
                    return (
                        ...
                        (t.prototype.render = function (t) {
                            ...
                            for (var o = 0; o < i.definitions.length; o++) {
                                ...
                                (n.innerHTML = f[i.definitions[o]]),
                                    i.definitions[o] == i.curDef &&
                                        (p.addClass(n, 'current'),
                                        (this.currentItem = n)),
                                    n.setAttribute(
                                        'data-def',
                                        i.definitions[o],
                        ...
                        (t.prototype.setClarity = function (e) {
                            e &&
                                ...
                                p.addClass(
                                    document.querySelector(
                                        '.vcp-vertical-switcher-item[data-def="' +
                                            e +
                                            '"]',
                                    ),
                                    'current',
                                ),
                                (this.currentItem = document.querySelector(
                                    '.vcp-vertical-switcher-item[data-def="' +
                                        e +
                                        '"]',
                                )),
            ...
            var a =
                ...
                g = (function (e) {
                    function t(i) {
                        ...
                        return (
                            o.options.poster && 'object' == a(o.options.poster)
                    ...
                    return (
                        ...
                        (t.prototype.handleMsg = function (e) {
                            switch (e.type) {
                                ...
                                case v.MSG.Pause:
                                    if (!this.__loaded) break;
                                    this.options.pausePosterEnabled === !0 &&
        ...
        function (e, t, i) {
            ...
            var a = i(24),
                ...
                f = {
                    ...
                    EnvFlashError:
                        '褰撳墠绯荤粺鐜涓嶆敮鎸佹挱鏀捐瑙嗛鏍煎紡',
                    VideoSourceError:
                        '鑾峰彇瑙嗛澶辫触锛岃妫€鏌ユ挱鏀鹃摼鎺ユ槸鍚︽湁鏁�',
                    NetworkError:
                        '缃戠粶閿欒锛岃妫€鏌ョ綉缁滈厤缃垨鑰呮挱鏀鹃摼鎺ユ槸鍚︽纭�',
                    VideoDecodeError: '瑙嗛瑙ｇ爜閿欒',
                    ArgumentError:
                        '浣跨敤鍙傛暟鏈夎锛岃妫€鏌ユ挱鏀惧櫒璋冪敤浠ｇ爜',
                    UrlEmpty: '璇峰～鍐欒棰戞挱鏀惧湴鍧€',
                    FileProtocol:
                        '璇峰嬁鍦╢ile鍗忚涓嬩娇鐢ㄦ挱鏀惧櫒锛屽彲鑳戒細瀵艰嚧瑙嗛鏃犳硶鎾斁',
                    LiveFinish: '鐩存挱宸茬粨鏉�,璇风◢鍚庡啀鏉�',
                    CrossDomainError:
                        '鏃犳硶鍔犺浇瑙嗛鏂囦欢锛岃法鍩熻闂鎷掔粷',
                    Ie9IframeFullscreenError:
                        '鍦↖E9涓敤iframe寮曠敤鐨勫疄渚嬫棤娉曟敮鎸佸叏灞�',
                },
                y = {
                    FileProtocol: [10],
                    ArgumentError: [11],
