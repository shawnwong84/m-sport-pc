        ...
        <div class="w-1200">
            <div class="match-top">
                <div class="fx align-items">
                    <div class="c-69" style="text-align: right">
                        <div class="fs-20 fw-700">
                            {{
                                ballData.matchGameInfo.teamInfo.homeTeam
                                    .teamName
                            }}
                        </div>
                ...
                <div class="ta-c">
                    <div class="fs-12 c-69">
                        2021-{{ ballData.matchGameInfo.matchDay }}
                        {{ ballData.matchGameInfo.matchTime }}
                    </div>
                    <div class="competitionShortName">
                        {{ ballData.matchGameInfo.competitionShortName }}
                    </div>
                </div>
                <div
                    class="fx align-items"
                    v-if="ballData.matchGameInfo.teamInfo.awayTeam"
                >
                    <div class="mr-10">
                        <img
                            :src="
                                ballData.matchGameInfo.teamInfo.awayTeam
                                    .teamLogo
                            "
                            style="width: 64px; height: 64px"
                        />
            ...
            <div class="jifen">
                ...
                <div class="fx align-items pl-10 pr-10 pt-10">
                    ...
                    <img
                        :src="ballData.matchGameInfo.teamInfo.homeTeam.teamLogo"
                        style="width: 15px; height: 15px"
                        class="mr-5"
                    />
                    <div>
                        {{ ballData.matchGameInfo.teamInfo.homeTeam.teamName }}
                    </div>
                </div>
                <table class="table">
                    <tr class="bg-e6">
                ...
                <div class="fx align-items mt-20 pl-10 pr-10">
                    ...
                    <img
                        :src="ballData.matchGameInfo.teamInfo.awayTeam.teamLogo"
                        style="width: 15px; height: 15px"
                        class="mr-5"
                    />
                    <div>
                        {{ ballData.matchGameInfo.teamInfo.awayTeam.teamName }}
                    </div>
                </div>
                <table class="table">
                    <tr class="bg-e6">
